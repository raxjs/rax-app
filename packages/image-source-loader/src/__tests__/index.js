...
describe('test image source loader', () => {
  it('output the base64 string', () => {
    ...
    const result = imageSourceLoader.call(thisObj, Buffer.from(aBase64String, 'base64'));
  ...
  it('should set extension for jpg', () => {
    ...
    const result = imageSourceLoader.call(thisObj, Buffer.from(''));
  ...
  it('should throw an error on unknown file extension', () => {
    ...
    expect(imageSourceLoader.bind(thisObj, Buffer.from(''))).toThrow(Error);
  });
