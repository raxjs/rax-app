...
const ColorPropTypes = {
  ...
  borderTopColor: PropTypes.color,
  borderRightColor: PropTypes.color,
  borderBottomColor: PropTypes.color,
  borderLeftColor: PropTypes.color,
  itemColor: PropTypes.color,
