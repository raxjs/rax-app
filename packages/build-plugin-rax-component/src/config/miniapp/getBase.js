...
module.exports = (context, target, options = {}, onGetWebpackConfig) => {
  const { platform = targetPlatformMap[target], mode = 'build', entryPath = './src/index', distDir = '', disableCopyNpm = mode === 'build', turnOffSourceMap = false, constantDir = [], configWebpack } = options[target] || {};
